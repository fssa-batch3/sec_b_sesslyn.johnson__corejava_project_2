...
public class DesignValidator {
	 ...
	 * @throws ValidationException If the ID is invalid or not associated with a
	 *                             designer.
	 * @throws ServiceException    If a service-related error occurs during
	 *                             validation.
	 */
	...
	public static void validateUpdateDesignFields(int id, Design updateDesign)
			throws ValidationException, ServiceException {

		DesignService designService = new DesignService();
		Design design = designService.findByDesignId(id);
		...
		if ((newName != null && !newName.equals(oldName))
				...
				|| (newLocation != null && !newLocation.equals(oldLocation))
				|| (newStyleId != 0 && newStyleId != oldStyleId)
				|| (newCreatedBy != 0 && newCreatedBy != oldCreatedBy)) {
		} else {
